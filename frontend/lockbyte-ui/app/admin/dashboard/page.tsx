    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Link href="/admin/users">
          <StatCard icon={Icons.Users} title="Total Users" value="1,283" color="168, 85, 247" />
        </Link>
        <Link href="/admin/labs">
          <StatCard icon={Icons.Labs} title="Total Labs" value="72" color="168, 85, 247" />
        </Link>
        <Link href="/admin/topics">
          <StatCard icon={Icons.Topics} title="Total Topics" value="15" color="168, 85, 247" />
        </Link>
        <Link href="/admin/solves">
          <StatCard icon={Icons.Flag} title="Total Solves" value="8,491" color="168, 85, 247" />
        </Link>
      </div>
