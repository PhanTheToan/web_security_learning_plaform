      ...
      <div className="flex items-center space-x-4">
        ...
        >
          ...
          <SelectContent className="bg-[#1a1a2e] border-[#ffffff]/20 text-white">
            <SelectItem value="all" className="hover:bg-[#9747ff]/20 focus:bg-[#9747ff]/20">All Statuses</SelectItem>
            <SelectItem value="SENT" className="hover:bg-[#9747ff]/20 focus:bg-[#9747ff]/20">Sent</SelectItem>
            <SelectItem value="FAILED" className="hover:bg-[#9747ff]/20 focus:bg-[#9747ff]/20">Failed</SelectItem>
          </SelectContent>
        </Select>
      </div>
