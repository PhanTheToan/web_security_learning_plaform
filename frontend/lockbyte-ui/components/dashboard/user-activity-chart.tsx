...
// --- Custom Tooltip (trắng, giống admin) ---
...
export function UserActivityChart() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setIsLoading(true);
            try {
                // Dữ liệu theo cấu trúc bạn đưa: { body: { solved:[], expired:[] } }
    ...
    return (
        <div className="bg-gradient-to-br from-[#ffffff]/8 via-[#9747ff]/5 to-[#5a5bed]/8 backdrop-blur-sm p-6 rounded-xl border border-[#ffffff]/10 hover:border-[#9747ff]/60 transition-all duration-300 h-full shadow-[0_0_15px_rgba(151,71,255,0.15)]">
            ...
            <ResponsiveContainer width="100%" height={300}>
                {isLoading ? (
                    <div className="flex h-full w-full items-center justify-center text-white/70">Loading Chart...</div>
                ) : chartData.length === 0 ? (
