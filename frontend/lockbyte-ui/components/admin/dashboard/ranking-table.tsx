...
import { ArrowUpDown, BrainCircuit, Clock, AlertTriangle } from "lucide-react"
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b border-white/10">
                    ...
                    {renderHeader('labsSolved', 'Labs Solved', <BrainCircuit className="mr-2 h-4 w-4" />)}
                    {renderHeader('totalTimeMinutes', 'Total Time', <Clock className="mr-2 h-4 w-4" />)}
                    {renderHeader('totalErrors', 'Total Errors', <AlertTriangle className="mr-2 h-4 w-4" />)}
                  </TableRow>
                </TableHeader>
                <TableBody>
